...
checkout_git("swift", "ssh://git@github.com/apple/swift.git", "swift-3.0-preview-4-branch")
...
checkout_git("lldb", "ssh://git@github.com/apple/swift-lldb.git", "swift-3.0-preview-4-branch")

if args.package:
    checkout_git("llbuild", "ssh://git@github.com/apple/swift-llbuild.git", "swift-3.0-preview-4-branch")
    checkout_git("swiftpm", "ssh://git@github.com/apple/swift-package-manager.git", "swift-3.0-preview-4-branch")
    checkout_git("swift-corelibs-foundation", "ssh://git@github.com/apple/swift-corelibs-foundation.git", "swift-3.0-preview-4-branch")
    checkout_git("swift-corelibs-xctest", "ssh://git@github.com/apple/swift-corelibs-xctest.git", "swift-3.0-preview-4-branch")
    checkout_git("swift-integration-tests", "ssh://git@github.com/apple/swift-integration-tests.git", "swift-3.0-preview-4-branch")
