...
checkout_git("llvm", "ssh://git@github.com/apple/swift-llvm.git", "swift-2.2-branch")
checkout_git("clang", "ssh://git@github.com/apple/swift-clang.git", "swift-2.2-branch")
checkout_git("swift", "ssh://git@github.com/apple/swift.git", "swift-2.2-branch")
...
checkout_git("lldb", "ssh://git@github.com/apple/swift-lldb.git", "swift-2.2-branch")
