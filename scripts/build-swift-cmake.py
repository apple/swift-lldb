...
checkout_git("llvm", "ssh://git@github.com/apple/swift-llvm.git", "swift-3.0-PREVIEW-1")
checkout_git("clang", "ssh://git@github.com/apple/swift-clang.git", "swift-3.0-PREVIEW-1")
checkout_git("swift", "ssh://git@github.com/apple/swift.git", "swift-3.0-preview-1-branch")
# checkout_git("swift/benchmark/PerfTestSuite", "*TODO somewhere*", "swift-3.0-preview-1-branch")
...
checkout_git("lldb", "ssh://git@github.com/apple/swift-lldb.git", "swift-3.0-preview-1-branch")

if args.package:
    checkout_git("llbuild", "ssh://git@github.com/apple/swift-llbuild.git", "swift-3.0-preview-1-branch")
    checkout_git("swiftpm", "ssh://git@github.com/apple/swift-package-manager.git", "swift-3.0-preview-1-branch")
